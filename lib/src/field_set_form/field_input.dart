...
abstract class FieldInput<T, E extends FieldInputError, EventType extends FieldSetFormInputEvent>
    extends Field<T?> {
  ...
  @override
  FieldInput<T, E, EventType> copyWith({T? value, bool? isPure});
  ...
  @override
  List<Object?> get props => [eventType, name, value, isPure];
}

class RequiredFieldInput<
  T,
  E extends RequiredFieldInputError,
  EventType extends FieldSetFormInputEvent
>
    extends FieldInput<T, E, EventType> {
